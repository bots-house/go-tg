...
func (h Handler) setupHandlers(api *operations.BirzzhaAPI) {
	...
	api.AdminAdminCancelLotHandler = adminops.AdminCancelLotHandlerFunc(h.adminCancelLot)
	api.AdminAdminRefreshLotHandler = adminops.AdminRefreshLotHandlerFunc(h.adminRefreshLot)
	...
	api.AdminAdminUpdateSettingsGarantHandler = adminops.AdminUpdateSettingsGarantHandlerFunc(h.adminUpdateSettingsGarant)
