...
// InputAdminSettingsPrices input admin settings prices
//
// swagger:model InputAdminSettingsPrices
type InputAdminSettingsPrices struct {
...
func (m *InputAdminSettingsPrices) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InputAdminSettingsPrices) validateApplication(formats strfmt.Registry) error {
...
func (m *InputAdminSettingsPrices) validateChange(formats strfmt.Registry) error {
...
func (m *InputAdminSettingsPrices) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InputAdminSettingsPrices) UnmarshalBinary(b []byte) error {
	var res InputAdminSettingsPrices
