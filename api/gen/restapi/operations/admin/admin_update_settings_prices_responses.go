...
func (o *AdminUpdateSettingsPricesOK) WithPayload(payload *models.AdminSettings) *AdminUpdateSettingsPricesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the admin update settings prices o k response
func (o *AdminUpdateSettingsPricesOK) SetPayload(payload *models.AdminSettings) {
	o.Payload = payload
}
