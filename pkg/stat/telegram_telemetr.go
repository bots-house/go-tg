...
var _ Telegram = &TelegramTelemetr{}
...
func (tm *TelegramTelemetr) Get(ctx context.Context, query string) (*TelegramStats, error) {
	...
	responseOk := struct {
		Res struct {
			ViewsPerPostAvg int `json:"views_per_post_avg,string"`
			ViewsPerPost24  int `json:"views_per_post_24,string"`
		} `json:"res"`
	}{}
	...
	return &TelegramStats{
		ViewsPerPostDaily: responseOk.Res.ViewsPerPost24,
		ViewsPerPostAvg:   responseOk.Res.ViewsPerPostAvg,
	}, nil
}
